...
void Player::setLayer(Layer * layer, bool game)
{
	...
	if (game) {
		auto UIBack = Sprite::createWithTexture(cuey->texture("Main/¿Â∫Ò√¢.png"));
...
{
	_isDead = true;
	AudioEngine::play2d("Sound/ƒ≥∏Ø≈Õ¡◊¿Ω.mp3", false, 1.0f);
...
void Player::levelUp()
{
	AudioEngine::play2d("Sound/∑π∫ßæ˜.mp3", false, 1.0f);
