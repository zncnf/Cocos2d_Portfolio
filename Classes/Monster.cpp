...
Monster::Monster(Layer* layer) {
	...
	case 2:_mob = ∏∂¿Ã≥ _¡ª∫Ò; break;
	case 3:_mob = Ω∫ƒÃ∑π∞Ô; break;
	case 4:_mob = ƒßπ¨¿«_æœªÏ¿⁄; break;
	case 5:_mob = ¿˝∏¡¿«_≥Ø∞≥; break;		
	}
	...
	case µ≈¡ˆ:
		...
		break;
	case ∏∂¿Ã≥ _¡ª∫Ò:
		cache->addSpriteFramesWithFile("Monster/∏∂¿Ã≥  ¡ª∫Ò.plist");
		_code = "∏∂¿Ã≥  ¡ª∫Ò";
		_standCount = 2;
		_moveCount = 2;
		_attackCount = 12;
		...
		break;
	case Ω∫ƒÃ∑π∞Ô:
		cache->addSpriteFramesWithFile("Monster/Ω∫ƒÃ∑π∞Ô.plist");
		_code = "Ω∫ƒÃ∑π∞Ô";
		_standCount = 5;
		_moveCount = 3;
		_attackCount = 16;
